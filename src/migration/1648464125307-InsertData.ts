...
export class InsertData1648464125307 implements MigrationInterface {
  name = 'InsertData1648464125307';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `INSERT INTO "aggregation_link_type" ("id", "title") VALUES ('9cd852b8-4a8d-7d97-8aba-004600e617f1', 'jira');`,
    );
    await queryRunner.query(
      `INSERT INTO "scheduler_config"("link_type","url","start_date","is_active","aggregation_frequency","team_id") Values('9cd852b8-4a8d-7d97-8aba-004600e617f1','url-sample','2022-03-28 19:30:00',true,10,'46455bf7-ada7-495c-8019-8d7ab76d489e');`,
    );
  }
