...
export class CreateTables1635325301462 implements MigrationInterface {
    name = 'CreateTables1635325301462'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "ad_center" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "version" integer NOT NULL DEFAULT '1', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying(255) NOT NULL, CONSTRAINT "PK_e55cde54b4029f701207982ef40" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "team_status" ("id" SERIAL NOT NULL, "status_name" character varying(255) NOT NULL, "status_description" character varying(1000), CONSTRAINT "PK_92697dc429f17bcf55a604fc717" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "links_category" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "version" integer NOT NULL DEFAULT '1', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "title" character varying(255) NOT NULL, CONSTRAINT "PK_42692729856abf63f8081f29394" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "team" ADD CONSTRAINT "FK_8e571805766848ea10996a178d4" FOREIGN KEY ("ad_center_id") REFERENCES "ad_center"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "team" ADD CONSTRAINT "FK_659c6ff656130dcfac850b66c38" FOREIGN KEY ("team_status_id") REFERENCES "team_status"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user_team" ADD CONSTRAINT "FK_f7c7dca694de337fa4a89d73ec8" FOREIGN KEY ("user_Id") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user_team" ADD CONSTRAINT "FK_8d8673f465f0797bf6126766c96" FOREIGN KEY ("team_Id") REFERENCES "team"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "sprint" ADD CONSTRAINT "FK_738321a380b6d8e5266516b5302" FOREIGN KEY ("team_id") REFERENCES "team"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "client_status" ADD CONSTRAINT "FK_16a31ed3a3cc5249369bbd25c9a" FOREIGN KEY ("sprintId") REFERENCES "sprint"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "code_quality_snapshot" ADD CONSTRAINT "FK_03be61d9d46dd39f1f355862e32" FOREIGN KEY ("team_id") REFERENCES "team"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "sprint_snapshot" ADD CONSTRAINT "FK_fb748d58ef594e8505aa9970d98" FOREIGN KEY ("sprint_id") REFERENCES "sprint"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "sprint_snapshot_metric" ADD CONSTRAINT "FK_ea96cf0fa988134725f6ad0984b" FOREIGN KEY ("snapshot_id") REFERENCES "sprint_snapshot"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "team_spirit_median" ADD CONSTRAINT "FK_103f28512266352104e3edea624" FOREIGN KEY ("team_name") REFERENCES "team"("name") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "team_spirit" ADD CONSTRAINT "FK_c258101a9e329fc1cf1ca460195" FOREIGN KEY ("sprint_id") REFERENCES "sprint"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "multimedia" ADD CONSTRAINT "FK_2ff4d18f9dd41c4eb24e891d47f" FOREIGN KEY ("multimedia_team_id") REFERENCES "team"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "files" ADD CONSTRAINT "FK_2d5c878843b5fb237d9633960cb" FOREIGN KEY ("multimedia_album_id") REFERENCES "multimedia"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "team_links" ADD CONSTRAINT "FK_abb01893e179023bcfcce0e6ea6" FOREIGN KEY ("link_title") REFERENCES "links_category"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "team_links" ADD CONSTRAINT "FK_e2facb7b8634882f8a0ee04979f" FOREIGN KEY ("team_id") REFERENCES "team"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "visibility" ADD CONSTRAINT "FK_396c9b89d74447b5dd2e60b9b24" FOREIGN KEY ("visibility_team_id") REFERENCES "team"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
